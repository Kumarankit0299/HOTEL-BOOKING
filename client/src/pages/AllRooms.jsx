    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'> 
        ...
        <div className='flex flex-col items-start text-left' >
          ...
          {roomsDummyData.map((room)=>(
            <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 norder-b border-gray-300 last:pb-30 last:border-0'> 
              <img onClick={()=> {navigate(`/rooms/${room._id}`); scrollTo(onabort,o)}} 
              ...
              <div className='md:w-1/2 flex flex-col gap-2'>
                ...
                <p onClick={()=> {navigate(`/rooms/${room._id}`); scrollTo(onabort,o)}} 
                 className='text-gray-800 text-3xl font-playfair cursor-pointer'>{room.hotel.name}</p>
                <div className='flex items-center'>
                       <StarRating />
                  <p className='ml-2'>200+ reviews</p>
                  </div>
                  <div className='flex items-center gap-1 text-grey-500 mt-2 text-sm'>
                  ...
                  <p className='text-x; font-medium text-grey-700'>${room.pricePerNight} /night</p>
              </div>
            </div>
          ))}
         ...
         {/* {Filter } */}
         <div className='bg-white w-80 border border-gray-300 text-gray-600 ma-lg:mb-8 min-lg:mt-16'> 
