...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <Title title='My Bookings' subTitle='Easily manage your past, current, and upcomig hotel reservations in one place. plan your trips seamlessly with just a few clicks' align='left' />
            ...
            {/* {Payment Status} */}
                 <div className='flex flex-col items-start justify-center pt-3'>
                    <div className='flex items-center gap-2'>
                         <div className={`h3 w-3 rounded-full ${booking.isPaid ? "bg-green-500" : "bg-red-500"}`}> </div>
